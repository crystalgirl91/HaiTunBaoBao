...
* Description
*/
angular.module('products_insurance', ["ng", "common", "directives"])
.controller('productsInsuranceController', ['$scope','$API','queryParams','dialog',function($scope,$API,queryParams,dialog){
	
	$scope.grades = [1,2,3,4,5];
	$scope.pay = function(){
		location.href = "./products_insurance_order.html" + location.search;
	};
