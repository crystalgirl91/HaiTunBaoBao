...
angular.module("products_control_order", ["ng", "common","area","ngCookies"])
.controller('productsControlOrderController', ['$scope','$API','queryParams','serialParams','dialog','$cookies', function($scope, $API,queryParams,serialParams,dialog,$cookies){
	let qs = queryParams;
	...
	$API.ctrlProdDetail(prodAid).then(data => {
