...
* Description
*/
angular.module('products.insurance.order', ["ng", "common", "directives","area","ngCookies"])
.config(['$sceProvider',function($sceProvider) {
	$sceProvider.enabled(false);
}])
.controller('productsInsuranceOrderController', ['$scope','$API','queryParams','serialParams','$filter','cnid','dialog','$uibModal','$cookies',function($scope,$API,queryParams,serialParams,$filter,cnid,dialog,$uibModal,$cookies){
	...
	.then(() => {
		return $API.getUserInfo(true).then((res) =>{
