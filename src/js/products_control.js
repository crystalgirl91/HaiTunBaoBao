...
* Description
*/
angular.module('products_control', ["ng", "common", "directives"])
.config(['$sceProvider',function($sceProvider) {
	$sceProvider.enabled(false);
}])
.controller('productsControlController', ['$scope','$API','queryParams','$sce','serialParams','dialog', function($scope,$API,queryParams,$sce,serialParams,dialog){
	...
	$scope.ok = function(){
		...
		location.href = "./products_control_order.html" + serialParams({
	...
	$scope.data = {};
	$API.ctrlProdDetail(queryParams.prodAid).then(function(res){
