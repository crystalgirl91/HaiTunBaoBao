...
angular.module("credits.pay.failure", ["ng", "common","directives"])
.controller("creditsPayFailureController", ["$scope", "$API","queryParams", function($scope, $API,queryParams){
